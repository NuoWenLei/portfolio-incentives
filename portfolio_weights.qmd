...
Portfolio weights allow the calculation of each participant's payout individually, therefore we can also introduce other incentives such as a penalty for transaction cost or liquidity.
