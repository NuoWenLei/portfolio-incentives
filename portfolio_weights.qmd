...
Rnumerai is working with the constraints of the current Numerai contest, in which participants can only submit scores. It would be better if participants can submit weights.
